    ...
    <header class="header">
        <div class="header-content">
            ...
            <div class="breadcrumb">
                <a href="dashboard.php">Dashboard</a> → Book Details
            </div>
        </div>
    </header>
    ...
    <div class="card">
        ...
        <?php
            ...
            if ($rowCount > 0) {
                ...
                echo "<span class='stat-label'>Total Books</span>";
                echo "</div>";
                echo "</div>";
                ...
                echo "<p>📚 No book records found in the library system.</p>";
                echo "<p>Start by adding your first book to begin building your library collection.</p>";
                echo "</div>";
            }
        ...
        <div class="button-container">
            <button class="add-btn" onclick="window.location.href = 'add_bookDetails.php';">
                ➕ Add New Book
            </button>
