...
<head>
  ...
  <style>
    * {
    ...
    /* Add Issue Button - Special Style */
    .add-btn {
...
<body>
    ...
    <header class="header">
        <div class="header-content">
            ...
            <div class="breadcrumb">
                <a href="dashboard.php">Dashboard</a> → Book Issue
            </div>
        </div>
    </header>
    ...
    <div class="card">
        ...
        <?php
            ...
            try {
                $stmt = $pdo->query("SELECT * FROM book_issue");
            ...
            if ($rowCount > 0) {
                ...
                echo "<span class='stat-label'>Total Issues</span>";
                echo "</div>";
                echo "</div>";
                ...
                echo "<p>📋 No book issue records found in the library system.</p>";
                echo "<p>Start by issuing your first book to begin tracking library transactions.</p>";
                echo "</div>";
            }
        ...
        <div class="button-container">
            <button class="add-btn" onclick="window.location.href = 'add_bookIssue.php';">
                ➕ Issue New Book
            </button>
