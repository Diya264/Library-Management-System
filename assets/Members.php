...
<head>
  ...
  <style>
    * {
    ...
    /* Add Member Button - Special Style */
    .add-btn {
    ...
    <div class="card">
        ...
        <?php
            ...
            if ($rowCount > 0) {
                ...
                echo "<span class='stat-label'>Total Members</span>";
                echo "</div>";
                echo "</div>";
                ...
                echo "<p>📚 No member records found in the library system.</p>";
                echo "<p>Start by adding your first member to begin managing your library community.</p>";
                echo "</div>";
            }
        ...
        <div class="button-container">
            <button class="add-btn" onclick="window.location.href = 'add_Members.php';">
                ➕ Add New Member
            </button>
